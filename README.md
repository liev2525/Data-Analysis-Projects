...
This salary dataset contains real-world salary information collected from multiple companies across different locations, job roles, and employment types. The goal of this analysis is to help future job seekers to understand salary trends, pay distribution, and factors influencing compensation in the job market.  The data is read into Databricks using SQL performing exploratory analysis and data profiling, followed by data formatting and standardization utilizing the medallion architecture to create a few simple visualizations using Databricks visualization tools as well as Tableau.

#### Key Objectives and Highlights
Job Role Salary Insights: Calculated average salary, title, experience and geographical location for those in related IT fields such as Data, AI, Business Intelligence and Software Engineering.

Work Type by Geographical Location: Assessing job role demographics and geographical trends by salary.
